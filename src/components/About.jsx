...
const About = () => {
  return (
    <div
      name="about"
      className="w-full md:h-[80vh] bg-gradient-to-b from-gray-800 to-black text-white"
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <p className="text-lg sm:text-xl mt-20">
          Hello there! I{"'"}m <span className=" text-cyan-500">Ferdause AL Mahmud</span>, a passionate and ambitious MERN Stack Developer eager to embark on a journey in the dynamic world of web development.
        </p>
        <br />
